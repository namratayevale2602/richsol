...
const Blog = ({ img, title }) => {
  ...
  return (
    <section className="flex items-center py-10 sm:py-16 lg:py-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl w-full">
        {/* Section Header - Updated to match SERVICES WE OFFER styling */}
        <div className="grid max-w-5xl mx-auto lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-30 font-[Poppins] tracking-tight">
              BLOG &
              <br />
              INSIGHTS
            </h2>
