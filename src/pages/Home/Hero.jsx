...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative flex flex-col items-center justify-center text-center px-2 sm:px-6 pt-24 md:pt-34 sm:pt-38 bg-gradient-to-br from-white via-blue-50/20 to-white overflow-hidden"
    >
      ...
      >
        ...
        <motion.h1
          variants={itemVariants}
          className="text-2xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 mb-4 leading-tight"
        >
          From Strategy to Software
          <br />
          <motion.span
            className="bg-gradient-to-r from-[#0cc0e1] via-[#83bfdf] to-[#137bca] bg-clip-text text-transparent"
        ...
        <motion.p
          variants={itemVariants}
          className="text-md sm:text-xl text-gray-600 mb-4 leading-relaxed max-w-3xl mx-auto"
        >
